...
/**
    ...
    public class stageControl extends JInternalFrame  implements MMListenerInterface{
         ...
         */
        public stageControl(ScriptInterface gui) {
            gui_ = gui;
        ...
        private void initComponents() {
           ...
           // setLocationByPlatform(true);
            setResizable(false);
            BasicInternalFrameUI this_bi = (BasicInternalFrameUI) this.getUI();
            this_bi.setNorthPane(null);

//          RappGui.getInstance().addWindowListener(new java.awt.event.WindowAdapter() {
